...
<body>
	<table width="99%">
		<tr>
			...
			<td width="29%" style="border: none;"><strong>Chalan No.:</strong></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="29%" style="border: none;">
				<?php 
					echo substr_replace($data[0]->invoice_no, "WCH", 0, 4);
				?>
	...
	<table width="99%">
		<tr>
			<td width="20%" style="vertical-align: top; border: none;">With Best Regards: </td>
		</tr>
	</table>
</body>
