              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="biller_name" name="biller_name" value="<?php echo $row->biller_name; ?>">
                     <input type="hidden" name="id" value="<?php echo $row->biller_id;?>">
