    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('client'); ?>" class="text-black"><!-- Client --><strong>Client</strong></a></li>
          <li><a href="<?php echo base_url('type'); ?>" class="text-black"><!-- Client Type --><strong>Client Type</strong></a></li>
          <li class="active"><!-- Add Client Type --> Add Client Type</li>
        </ol>
      </h5>    
    </section>
    <!-- Main content -->
      ...
      <div class="col-sm-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- Add Client Type -->Add Client Type</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="form" method="post" action="<?php echo base_url('client/addTypeDetails');?>">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="type_name"><!-- Type Name -->Type Name <span class="validation-color">*</span></label>
                    <input type="text" class="form-control" id="type_name" name="type_name" value="<?php echo set_value('type_name'); ?>">
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    <button type="submit" id="submit" class="btn bg-gray">&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;</button>
                    <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('type')"><!-- Cancel --><?php echo $this->lang->line('category_cancel'); ?></span>
                  </div>
                </div>
              </form>
              </div>
