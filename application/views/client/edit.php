      ...
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('client'); ?>" class="text-black">
              <!-- Client -->
              <strong><?php echo $this->lang->line('client_header'); ?> </strong>     
            </a>
        </li>
          <li class="active"><!-- Edit Client -->
            <?php echo $this->lang->line('edit_client_header'); ?>
          </li>
        </ol>
      </h5>    
    </section>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('client/editClient');?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="company_phone" name="company_phone" value="<?php echo $row->company_phone; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="contact_person" name="contact_person" value="<?php echo $row->contact_person; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="contact_person_phone" name="contact_person_phone" value="<?php echo $row->contact_person_phone; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="cc" name="cc" value="<?php echo $row->cc; ?>" data-toggle="tooltip" title="For multiple Cc, separate them by comma (,)">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="bcc" name="bcc" value="<?php echo $row->bcc; ?>" data-toggle="tooltip" title="For multiple Bcc, separate them by comma (,)">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="client_type" name="client_type" style="width: 100%;">
                        ...
                        ?>
                        <option 
                          value='<?php echo $key->client_type_id ?>' 
                          <?php 
                            if(isset($row->client_type_id)){
                              if($key->client_type_id == $row->client_type_id){
                                echo "selected";
                              }
                            } 
                          ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="country"><!-- Country --> 
                        Country <span class="validation-color">*</span></label>
                  ...
                  <div class="form-group state" <?php if($row->country_id == 18){ ?> style="display: none;" <?php }?>>
                  ...
                  <div class="form-group city" <?php if($row->country_id == 18){ ?> style="display: none;" <?php }?>>
                    <label for="city"><!-- City --> 
                        City 
                        <!-- <span class="validation-color">*</span> -->
                    </label>
                  ...
                  <div class="form-group city-area" <?php if($row->country_id != 18){ ?> style="display: none;" <?php }?>>
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input class="form-control" id="loc_city" name="loc_city" value="<?php echo $row->loc_city; ?>">
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control" id="loc_area" name="loc_area" value="<?php echo $row->loc_area; ?>">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <input class="form-control" id="road_no" name="road_no" value="<?php echo $row->road_no; ?>">
                      </div>
                      <div class="col-md-4">
                        <label for="house_no"><!-- House No --> 
                            House
                        </label>
                        <input class="form-control" id="house_no" name="house_no" value="<?php echo $row->house_no; ?>">
                      </div>
                      <div class="col-md-4">
                          <label for="zip_code">
                            Zip Code
                          </label>
                          <input type="text" class="form-control" id="zip_code" name="zip_code" value="<?php echo $row->zip_code; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="factory_address" name="factory_address" value="<?php echo $row->factory_address; ?>">
                  </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <input class="form-control" id="skype" name="skype" value="<?php echo $row->skype; ?>">
                      </div>
                      <div class="col-md-6">
                        <label for="qq"><!-- QQ --> 
                            QQ
                        </label>
                        <input class="form-control" id="qq" name="qq" value="<?php echo $row->qq; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <input class="form-control" id="whatsapp" name="whatsapp" value="<?php echo $row->whatsapp; ?>">
                      </div>
                      <div class="col-md-6">
                        <label for="wechat"><!-- We Chat --> 
                            We Chat
                        </label>
                        <input class="form-control" id="wechat" name="wechat" value="<?php echo $row->wechat; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <select class="form-control select2" id="responsible_person" name="responsible_person[]" style="width: 100%" multiple>
                      <?php
                        ...
                        foreach ($user as $key){
                          ...
                          ?>
                            <option value="<?php echo $key->id; ?>" <?php if($flag == 1){ echo "selected"; } ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" name="confirm" value="Active" <?php if($row->client_status == 'Active'){?> checked="checked" <?php }?> class="minimal"/>&nbsp;&nbsp;
                    <?php echo lang('category_status_n_label', 'confirm');?>
                    <input type="radio" name="confirm" value="Inactive"<?php if($row->client_status == 'Inactive'){?> checked="checked" <?php }?> class="minimal"/>
                  </div>
                </div>
                          ...
                          <?php 
                            if($kind_att){
                              for($i=0, $count = count($name); $i<$count; $i++){ 
                                $kind_name  = $name[$i];
                                $kind_designation = $designation[$i];
                          ?>
                                <tr class="kind_attention">
                                  <td><a class='deleteRow'></a></td>
                                  <td><input type="text" class="form-control" name="kind_name[]" id="kind_name" value="<?php echo $kind_name; ?>"></td>
                                  <td><input type="text" class="form-control" name="kind_designation[]" id="kind_designation" value="<?php echo $kind_designation; ?>"></td>
                                </tr>
                          <?php 
                              }
                            }
