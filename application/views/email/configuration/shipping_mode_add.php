    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><!-- Add shipping_mode_ec -->Add Shipping Mode</li>
        </ol>
      </h5>    
    </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- Add New shipping_mode_ec --> Add Shipping Mode</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="col-sm-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('email/addShippingMode');?>">
                  <div class="form-group">
                    <label for="shipping_mode_ec_name">Shipping Mode Name<span class="validation-color">*</span></label>
                    <input type="text" class="form-control" id="shipping_mode_ec_name" name="shipping_mode_ec_name" value="<?php echo set_value('shipping_mode_ec_name'); ?>">
                    <span class="validation-color" id="err_shipping_mode_ec_name"><?php echo form_error('shipping_mode_ec_name'); ?></span>
                  </div>
                  <div class="form-group">
                    <label for="shipping_mode_ec_details"> Details  <!-- <span class="validation-color">*</span> --></label>
                    <input type="text" class="form-control" id="shipping_mode_ec_details  " name="shipping_mode_ec_details" value="<?php echo set_value('shipping_mode_ec_details'); ?>">
                    <!-- <span class="validation-color" id="err_shipping_mode_ec_details"><?php echo form_error('shipping_mode_ec_details'); ?></span> -->
                  </div>
                      <div class="form-group">
                    <label for="shipping_mode_ec_status">Status <span class="validation-color">*</span></label><br>
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('email/shipping_mode_list')"><!-- Cancel --><?php echo $this->lang->line('category_cancel'); ?></span>
                  </div>
                </div>
                </form>
              </div>
