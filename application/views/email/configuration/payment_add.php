    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><!-- Add port_ec -->Add Payment Mode</li>
        </ol>
      </h5>    
    </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- Add New port_ec --> Add Payment</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="col-sm-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('email/addPayment');?>">
                  <div class="form-group">
                    <label for="payment_ec_name">Payment Name<span class="validation-color">*</span></label>
                    <input type="text" class="form-control" id="payment_ec_name" name="payment_ec_name" value="<?php echo set_value('payment_ec_name'); ?>">
                    <span class="validation-color" id="err_payment_ec_name"><?php echo form_error('payment_ec_name'); ?></span>
                  </div>          
                  <div class="form-group">
                    <label for="payment_ec_details"> Details  <!-- <span class="validation-color">*</span> --></label>
                    <input type="text" class="form-control" id="payment_ec_details" name="payment_ec_details" value="<?php echo set_value('payment_ec_details'); ?>">
                  </div>

                      <div class="form-group">
                    <label for="payment_ec_status">Status <span class="validation-color">*</span></label><br>
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('email/payment_list')"><!-- Cancel --><?php echo $this->lang->line('category_cancel'); ?></span>
                  </div>
                </div>
                </form>
              </div>
