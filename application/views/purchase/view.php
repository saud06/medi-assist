		            ...
		            <div class="box-body">
		            	<div class="col-sm-12 well well-sm">
			            	<div class="col-sm-12">
			            		...
			            		<div class="col-sm-2">
				            		<?php 
				            			if(!empty($data[0]->house_no)) echo $data[0]->house_no . ', ';
	                                    if(!empty($data[0]->road_no)) echo $data[0]->road_no . ',<br>';
				            		?>
				            		<?php
			            		...
			            		<div class="col-sm-2">
				            		<?php 
				            			echo 'Mode: ' . $data[0]->ship_mode . '<br>'; 
				            			echo '<hr style="margin: 2px">';
			                            if($data[0]->ship_mode == 'Courier'){
			                            	if($data[0]->type){
				                              $type = $this->db->get_where('courier', array('courier_id' => $data[0]->type))->row();
				                              echo 'Type: ' . $type->courier_name . '<br>'; 
				                          	}
				                          	else{
				                          		echo 'Type: <br>'; 
				                          	}
			                            }
			                            echo 'Freight Charge: ' . $data[0]->freight_charge . '<br>'; 
			                            echo 'Custom Charge: ' . $data[0]->custom_charge . '<br>'; 
			                            echo '<hr style="margin: 2px">';
			                            echo 'Method: ' . $data[0]->method . '<br>'; 

			                            if($data[0]->method == 'COD'){
			                            	echo 'Voucher No.: ' . $data[0]->voucher_no . '<br>'; 
			                            }
			                            elseif($data[0]->method == 'Bank'){
			                            	echo 'Bank Name: ' . $data[0]->bank_name . '<br>'; 
			                            }
			                            elseif($data[0]->method == 'Cheque'){
			                            	echo 'Receive Date: ' . $data[0]->receive_date . '<br>'; 
			                            	echo 'Receipt No: ' . $data[0]->receipt_no . '<br>'; 
			                            }
				            		?>
			            		</div>
			            	</div>
			            ...
			            <div class="col-sd-12">
			            	...
			            	<div class="col-sm-4">
			            		...
			            		<div class="col-sm-10">
				            		...
				            		<b><?php echo $this->lang->line('purchase_date')." : ".$data[0]->receipt_voucher_date; ?></b>
				            		<br>
			                        <b>&nbsp;
			            		</div>
			            	</div>
			            ...
			            <div class="col-sm-12">
			            	<div class="buttons">
								<div class="btn-group btn-group-justified">
									<!-- <?php if($data[0]->paid_amount == 0.00 || $data[0]->paid_amount == 0 || $data[0]->paid_amount == NULL){ ?>
									<div class="btn-group">
										<a class="tip btn btn-primary tip" href="<?php echo base_url('purchase/payment/'); ?><?php echo $data[0]->sales_id; ?>" title="Add Payment">
											<i class="fa fa-money"></i>
									...
									<div class="btn-group">
										<a class="tip btn btn-success" href="<?php echo base_url('purchase/edit/'); ?><?php echo $data[0]->purchase_id; ?>" title="Edit">
									...
									<?php if($this->session->userdata('type') == 'admin'){ ?>
										<div class="btn-group bg-gray" style="border: 2px solid black;">
									...
									<?php }?>
									<div class="btn-group bg-gray" style="border: 2px solid black;">
										<a class="tip btn btn-success" href="<?php echo base_url('purchase');?>" title="Sales List">
