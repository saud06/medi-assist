              ...
              <form role="form" id="form" method="post" action="<?php echo base_url('purchase/editPurchase');?>">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <div class="col-sm-6" style="padding-left: 0">
                      ...
                      <input type="radio" name="ship_mode" id="air" class="shippingCls" value="Air" <?php if($row->ship_mode == 'Air') {?> checked <?php }?>> Air &emsp;
                      <input type="radio" name="ship_mode" id="courier" class="shippingCls" value="Courier" <?php if($row->ship_mode == 'Courier') {?>checked <?php }?>> Courier &emsp;
                      <input type="radio" name="ship_mode" id="sea" class="shippingCls" value="Sea" <?php if($row->ship_mode == 'Sea') {?> checked <?php }?>> Sea &emsp;
                      <input type="radio" name="ship_mode" id="road" class="shippingCls" value="Road" <?php if($row->ship_mode == 'Road') {?> checked <?php }?>> Road &emsp;
                    </div>
                  ...
                  <div class="form-group processCls">
                    ...
                    <div class="col-sm-3 receive_date">
                      ...
                      <input type="text" name="receive_date" id="receive_date" class="form-control datepicker" placeholder="Insert Date" value="<?php if($row->receive_date != '0000-00-00'){ echo $row->receive_date; }?>">
                    </div>
                ...
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label for="product"> 
                        Batch No. <span class="validation-color">*</span>
                      </label>

                      <input type="text" name="rt_batch_no" id="rt_batch_no" class="form-control" placeholder="Insert Batch No.">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="product" name="product" style="width: 100%;" disabled>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div style="overflow-y: auto;">
                      <table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
                        <thead>
                          <tr>
                            ...
                            <th class="span2" width="15%">Batch No.</th>
                        ...
                        <tbody>
                          ...
                          foreach ($items as $key) {
                            ...
                            <tr>
                              <td>
                                ...
                                <td><input type="text" class="form-control" value="<?php echo $key->batch_no ?>" name="batch_no" id="batch_no" readonly>
                          ...
                          if(isset($batch_data)){
                            $batch_no = json_encode($batch_data);
                          }
                      ...
                      <input type="hidden" name="table_data0" id="table_data0" value='<?php echo $batch_no ?>'>
...
<script>
  $(document).ready(function(){
    $("#rt_batch_no").on("keyup change", function(event){
      if($(this).val() == ''){
        ...
        $.ajax({
          ...
          success: function(d){
            ...
            // if(flag == 0){
              ...
              cols += "<td><input type='text' name='batch_no"+ counter +"' id='batch_no"+ counter +"' value='"+ batch_no +"' class='form-control' readonly></td>";
    ...
    function calculateDiscountTax(row,data = 0,data1 = 0){
      ...
      product_data[key].batch_no = row.find('input[name^="batch_no"]').val();
