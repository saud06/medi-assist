                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <div class="col-sm-6" style="padding-left: 0">
                      ...
                      <input type="radio" name="ship_mode" id="air" class="shippingCls" value="Air"> Air &emsp;
                      <input type="radio" name="ship_mode" id="courier" class="shippingCls" value="Courier"> Courier &emsp;
                      <input type="radio" name="ship_mode" id="sea" class="shippingCls" value="Sea"> Sea &emsp;
                      <input type="radio" name="ship_mode" id="road" class="shippingCls" value="Road"> Road &emsp;
                    </div>
                  ...
                  <div class="form-group processCls">
                    ...
                    <div class="method" style="padding-left: 0; padding-right: 0">
                      <label for="method">
                    ...
                    <div class="col-sm-6 voucher_no" style="padding-left: 0; padding-right: 0">
                    ...
                    <div class="col-sm-6 bank_name" style="padding-left: 0; padding-right: 0">
                      <label for="bank_name">
                        Bank Name
                      </label><br>
                    ...
                    <div class="col-sm-3 receive_date" style="padding-left: 0; padding-right: 8px">
                      <label for="receive_date">
                        Receive Date
                      </label><br>

                      <input type="text" name="receive_date" id="receive_date" class="form-control datepicker" placeholder="Insert Date">
                    </div>

                    <div class="col-sm-3 receipt_no" style="padding-left: 8px; padding-right: 0">
