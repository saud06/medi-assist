...
<script type="text/javascript">
  function delete_id(id)
  {
     ...
     {
        window.location.href='<?php  echo base_url('rack/delete/'); ?>'+id;
     }
  }
</script>
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- List rack -->
                Rack List
              </h3>
              <a title="Add New rack" class="btn bg-gray" style="margin: 10px" href="<?php echo base_url('rack/add');?>">
            ...
            <div class="box-body outer-scroll">
              <div class="inner-scroll">
                <div class="row">
                  <div class="col-sm-12">
                    <strong>Rack List Filter:</strong> &emsp;
                    ...
                    <button title="Filter Rack List" type="button" id="btn_ajax" class="btn bg-gray"><i class="fa fa-search" aria-hidden="true"></i></button>&emsp;

                    <div class="btn-group">
                      <button title="Print Rack List" type="button" class="btn bg-gray gropdown-toggle" data-toggle="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li id="pdf">
                          <a href="<?php echo base_url('rack/list_pdf');?>" target="_blank">PDF (On Letter Head)</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                        ...
                        <?php if($this->session->userdata('type') == 'admin'){ ?>
                          <td>
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  <a href="<?php echo base_url('rack/edit/'); ?><?php echo $id; ?>"><i class="fa fa-edit"></i>Edit</a>
                                </li>
                                <li>
...
<script>
  $('#btn_ajax').click(function(){
    ...
    $.ajax({
      url: "<?php echo base_url('rack/filter_rack') ?>/",
      type: "POST",
      dataType: "JSON",
      data : {
        status: status
    ...
    $("#pdf").html('<a href="<?php echo base_url('rack/filterRackPDF/');?>' + status + '" target="_blank">PDF (On Letter Heads)</a>');
  });
