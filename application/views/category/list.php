              ...
              <div class="inner-scroll">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <button title="Filter Category List" type="button" id="btn_ajax" class="btn bg-gray"><i class="fa fa-search" aria-hidden="true"></i></button>&emsp;

                    <div class="btn-group">
                      <button title="Print Category List" type="button" class="btn bg-gray gropdown-toggle" data-toggle="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li id="pdf">
                          <a href="<?php echo base_url('category/list_pdf');?>" target="_blank">PDF (On Letter Head)</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                        ...
                        <?php if($this->session->userdata('type') == 'admin'){ ?>
                          <td>
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  <a href="<?php echo base_url('category/edit/'); ?><?php echo $id; ?>"><i class="fa fa-edit"></i>Edit</a>
                                </li>
                                <li>
...
<script>
  $('#btn_ajax').click(function(){
    ...
    $("#pdf").html('<a href="<?php echo base_url('category/filterListPDF/');?>' + status + '" target="_blank">PDF (On Letter Heads)</a>');
  });
