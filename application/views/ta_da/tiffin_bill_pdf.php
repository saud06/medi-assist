...
<body>
	...
	<table align="center" class="table" style="border: 1px solid black; border-collapse: collapse">
		<tbody>
			<tr>
				<td width="15%" align="center"><strong>Tiffin</strong></td>
            ...
            ?>
	            	<tr class="no-bottom-border">
	            		<td height="30px" align="center"><?php echo '&nbsp;&nbsp;' . $row->category_name; ?></td>
						<td height="30px" align="center"><?php echo '&nbsp;&nbsp;' . $row->category_details; ?></td>
			...
			<tr>
				<td colspan="3" align="center">In Words: <?php echo 'BDT ' . convert_number_to_words(number_format((float)$grand_total, 2, '.', '')) . ' Only.'; ?></td>
			</tr>
		</tbody>
	</table>
</body>
