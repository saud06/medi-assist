    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('shelf'); ?>" class="text-black">
            <!-- shelf -->
            <strong>Shelf</strong>
          </a></li>
          <li class="active"><!-- Add shelf -->Add Shelf</li>
        </ol>
      </h5>    
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><!-- Add New shelf --> Add Shelf</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="col-sm-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('shelf/addShelf');?>">
                  <div class="form-group">
                    <label for="shelf_name"><!-- shelf Name -->  <!-- <?php echo $this->lang->line('shelf_label_name'); ?> -->Shelf Name<span class="validation-color">*</span></label>
                    <input type="text" class="form-control" id="shelf_name" name="shelf_name" value="<?php echo set_value('shelf_name'); ?>">
                  ...
                  <div class="form-group">
                    <label for="shelf_status"><!-- Category Description -->Shelf Status <span class="validation-color">*</span></label><br>
                  ...
                  <div class="col-sm-12">
                    <div class="box-footer">
                      ...
                      <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('shelf')"><!-- Cancel --> <?php echo $this->lang->line('branch_label_cancel'); ?></span>
                    </div>
                  </div>
                </form>
              </div>
