...
<script type="text/javascript">
  function delete_id(id)
  {
     ...
     {
        window.location.href='<?php  echo base_url('employee/deleteType/'); ?>'+id;
     }
  }
</script>
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('employee/addType');?>"> 
                  <!-- Add New Client -->
                  Add Client Type  
               </a>
            </div>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo base_url('employee/editType/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
