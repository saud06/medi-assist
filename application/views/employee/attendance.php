              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" id="submit" class="button btn bg-gray" onclick="submit_leave()">
                      <span class="submit" style="left: 16%">Submit</span>
            ...
            <div class="modal fade" id="modal_holiday" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="submit" id="submit2" class="button btn bg-gray" onclick="submit_holiday()">
                      <span class="submit" style="left: 16%">Submit</span>
                      <span class="loading" style="left: 32%"><i class="fa fa-circle-o-notch"></i></span>
                    </button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
