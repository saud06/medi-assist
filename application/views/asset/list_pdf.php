...
<body>
	<h1 style="text-align: center;">Asset List</h1>

  <p style="text-align: center;"><?php if($this->uri->segment('3') && $this->uri->segment('4')){ ?> (From <strong><?= $this->uri->segment('3'); ?></strong> To <strong><?= $this->uri->segment('4'); ?></strong>) <?php } ?></p>
