      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Petty Cash</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <form role="form" id="form" method="post" action="<?php echo base_url('petty_cash/editPettyCash');?>" encType="multipart/form-data">
                <?php foreach($data as $row){?>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="date">Date <span class="validation-color">*</span></label>
                      <input type="text" class="form-control datepicker" id="date" name="date" value="<?php echo $row->cash_date; ?>">
                      <input type="hidden" name="id" value="<?php echo $row->petty_cash_id;?>">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea rows="1" class="form-control" id="remarks" name="remarks"><?php echo $row->remarks; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <input type="radio" name="confirm" value="inactive" <?php if($row->status == 'inactive'){?> checked="checked" <?php }?> class="minimal"/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('petty_cash')"><?php echo $this->lang->line('product_cancel'); ?></span>
                  </div>
                </div>
              </form>
            </div>
