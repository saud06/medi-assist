    ...
    <section class="content">
      ...
      <div class="col-sm-12">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" id="form" method="post" action="<?php echo base_url('employee/addTypeDetails');?>">
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <span class="btn btn-default" id="cancel" style="margin-left: 2%" onclick="cancel('type')"><!-- Cancel --><?php echo $this->lang->line('category_cancel'); ?></span>
                  </div>
                </div>
              </form>
              </div>
