      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-lg-12">
                  <form action="<?php echo base_url('employee/import_csv'); ?>" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <input type="hidden" name="token" value="b83dfa00669b155a37f921dd34e01d69" />  
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            <input type="submit" name="import" value="Import" class="btn bg-gray" />
                          </div>
                        </div>
                      </div>
                    </div>
