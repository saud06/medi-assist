  ...
  <section class="content-header">
    <h5>
      <ol class="breadcrumb">
        ...
        <li class="active"><!-- Edit Notice --> Edit Notice</li>
      </ol>
    </h5>
  </section>
  <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><!--Edit Notice--> Edit Notice</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <form role="form" id="form" method="post" action="<?php echo base_url('notice/editNotice');?>">
              <div class="col-sm-6">
                <div class="form-group">
                  <?php foreach($data as $row){?>
                  <label for="title"><!-- Notice Name  --> Title<span class="validation-color">*</span></label>
                  <input type="text" class="form-control" id="title" name="title" value="<?php echo $row->notice_title; ?>">
                  <input type="hidden" name="id" value="<?php echo $row->notice_id;?>">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control datepicker" id="date" name="date" value="<?php echo $row->notice_date; ?>">
                      <span class="validation-color pull-right" id="err_date"><?php echo form_error('date'); ?></span>
                    </div>

                    <div class="col-sm-6">
                      <div class="pull-right">
                        <label for="status"><!-- Notice Description --> Status </label><br>
                        <?php echo lang('category_status_y_label', 'confirm');?>
                        <input type="radio" name="confirm" value="active" <?php if($row->notice_status == 'Active') {?> checked="checked" <?php }?> class="minimal"/>&nbsp;&nbsp;
                        <?php echo lang('category_status_n_label', 'confirm');?>
                        <input type="radio" name="confirm" value="inactive" <?php if($row->notice_status != 'Active') {?> checked="checked" <?php }?> class="minimal"/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <textarea rows="4" class="form-control" id="notice_desc" name="notice_desc"><?php echo $row->notice_desc; ?></textarea>
                </div>
              </div>
              ...
              <div class="col-sm-12">
                <div class="box-footer">
                  ...
                  <span class="btn btn-danger" id="cancel" style="margin-left: 2%" onclick="cancel('notice')"><!-- Cancel --> Cancel</span>
                </div>
              </div>
            </form>
          </div>
